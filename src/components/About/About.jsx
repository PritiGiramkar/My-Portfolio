  ...
  return (
    <section className={styles.container} id="about">
      ...
      <div className={styles.content}>
        <img className={styles.aboutImage} src={getImageUrl("about/pritiabout.png")} alt="about imag" />
      <ul className={styles.aboutItems}>
        <li className={styles.aboutItem}>
          <img src={getImageUrl("about/cursorIcon.png")} alt="no available" />
        <div className={styles.aboutItemText}>
          <h3>FrontEnd Developer</h3>
          <p>I am Frontend developer with experience of developing responsive websites</p>
        </div>
        </li>
        <li className={styles.aboutItem}>
